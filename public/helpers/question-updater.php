...
$sth = sprintf("UPDATE mm_questions set que_level='%s', que_question='%s', que_correctAnswer='%s', que_wrongAnswerOne='%s', que_wrongAnswerTwo='%s', que_wrongAnswerThree='%s', que_catId='%s' WHERE que_id='%s'", $que_lvl, $que_question, $que_correctAnswer, $que_wrongAnswerOne, $que_wrongAnswerTwo, $que_wrongAnswerThree, $que_catId, $que_id);
